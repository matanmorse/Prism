...
const EmulatorNameAndIcon = ({emulatorName, size=3, bold=false, otherText, vertical=false} ) => {
    ...
    return (
        <>
            <div className="label-wrapper" style={{flexDirection: vertical ? 'column': 'row'}}>
                <img className='citra-logo' src={logo} style={{height: size * 7.5 + 'px', width: size * 7.5 + 'px'}} /> 
